...
class TideInfo(BaseModel):
    ...
    streams: Optional[str] = Field(None, description="Tidal stream directions, rates, and timings")
...
class DepartureETA(BaseModel):
    ...
    justification: Optional[str] = Field(None, description="Reasoning (tidal gate, daylight, etc.)")
